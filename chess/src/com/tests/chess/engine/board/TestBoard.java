...
//        assertEquals(board.getPiece(35), null);
    ...
    public void testPlainKingMove() {
        ...
        final Move move = Move.MoveFactory.createMove(board, BoardUtils.INSTANCE.getCoordinateAtPosition("e1"),
    ...
    public void mem() {
        ...
        System.out.println("createStandardBoard() took " + (start-end) + " bytes.");
